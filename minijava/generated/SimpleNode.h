...
#include "Token.h"
#include "Node.h"
#include "MiniJavaParserTreeConstants.h"
...
protected: 
  ...
  void*              value  = nullptr;
//int                numChildren;
  MiniJavaParser*    parser = nullptr;
  int                id = 0;

public: 
           SimpleNode(int id);
           SimpleNode(MiniJavaParser* parser, int id);
  virtual ~SimpleNode();
...
//#fi
  ...
  virtual void           jjtChildrenAccept(MiniJavaParserVisitor *visitor, void * data) const;
  virtual void           jjtChildAccept(int childNo, MiniJavaParserVisitor *visitor, void * data) const;
...
#endif
/* JavaCC - OriginalChecksum=4cd34658044a18c943a05ebb5bbba22c (do not edit this line) */
