...
const  int INTEGER_LITERAL = 6;
  /** RegularExpression Id. */
const  int DECIMAL_LITERAL = 7;
  /** RegularExpression Id. */
const  int HEX_LITERAL = 8;
  /** RegularExpression Id. */
const  int OCTAL_LITERAL = 9;
  /** RegularExpression Id. */
const  int INT = 10;
  /** RegularExpression Id. */
const  int BOOLEAN = 11;
  /** RegularExpression Id. */
const  int CLASS = 12;
  /** RegularExpression Id. */
const  int PUBLIC = 13;
...
const  int WHILE = 25;
  /** RegularExpression Id. */
const  int SYSTEM_OUT_PRINTLN = 26;
  /** RegularExpression Id. */
const  int LENGTH = 27;
  /** RegularExpression Id. */
const  int NOT = 28;
...
const  int IDENTIFIER = 52;
  /** RegularExpression Id. */
const  int IDENT_START = 53;
  /** RegularExpression Id. */
const  int IDENT_BODY = 54;
