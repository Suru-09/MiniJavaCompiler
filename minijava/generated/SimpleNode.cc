...
SimpleNode::SimpleNode(MiniJavaParser *parser, int id) :
     parser(parser), id(id) 
{
}
...
void  SimpleNode::jjtAccept(MiniJavaParserVisitor *visitor, void * data) const
{
    return visitor->visit(this, data);
}

void SimpleNode::jjtChildrenAccept(MiniJavaParserVisitor *visitor, void * data) const {
    for (int i = 0; i < children.size(); ++i) {
      children[i]->jjtAccept(visitor, data);
    }
}

void SimpleNode::jjtChildAccept(int childNo, MiniJavaParserVisitor *visitor, void * data) const {
...
/* JavaCC - OriginalChecksum=983d401a3c33f9ae8b37b715cda5fcee (do not edit this line) */
