...
JJSimpleString addUnicodeEscapes(const JJString& str);
  ...
  class PostfixParser;
  class ErrorHandler {
    friend class PostfixParserTokenManager;
    friend class PostfixParser;
    protected:
      int error_count;
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, const JJString& expectedToken, Token *actual, PostfixParser *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, const JJSimpleString& production, PostfixParser *parser) {
        error_count++;
      ...
      virtual void handleOtherError(const JJString& message, PostfixParser *parser) {
  ...
  class PostfixParserTokenManager;
  class TokenManagerErrorHandler {
    ...
    public:
       ...
       //
       virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, const JJString& errorAfter, JJChar curChar, PostfixParserTokenManager* token_manager) {
       ...
       virtual void lexicalError(const JJString& errorMessage, PostfixParserTokenManager* token_manager) {
...
/* JavaCC - OriginalChecksum=c550c950faaf9ac39539557f09f53b29 (do not edit this line) */
