...
#include "Token.h"
#include "Node.h"
#include "PrefixParserTreeConstants.h"
...
protected: 
  ...
  void*              value  = nullptr;
//int                numChildren;
  PrefixParser*    parser = nullptr;
  int                id = 0;

public: 
           SimpleNode(int id);
           SimpleNode(PrefixParser* parser, int id);
  virtual ~SimpleNode();
...
//#fi
  ...
  virtual void           jjtChildrenAccept(PrefixParserVisitor *visitor, void* data) const;
  virtual void           jjtChildAccept(int childNo, PrefixParserVisitor *visitor, void* data) const;
...
#endif
/* JavaCC - OriginalChecksum=41b78ef4b49183f04b9a478369f42dab (do not edit this line) */
