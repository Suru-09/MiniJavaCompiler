...
SimpleNode::SimpleNode(PrefixParser *parser, int id) :
     parser(parser), id(id) 
{
}
...
void* SimpleNode::jjtAccept(PrefixParserVisitor *visitor, void* data) const
{
    return visitor->visit(this, data);
}

void SimpleNode::jjtChildrenAccept(PrefixParserVisitor *visitor, void* data) const {
    for (int i = 0; i < children.size(); ++i) {
      children[i]->jjtAccept(visitor, data);
    }
}

void SimpleNode::jjtChildAccept(int childNo, PrefixParserVisitor *visitor, void* data) const {
...
/* JavaCC - OriginalChecksum=8852f60f23cf00a38937578d0eed587e (do not edit this line) */
