...
JJSimpleString addUnicodeEscapes(const JJString& str);
  ...
  class PrefixParser;
  class ErrorHandler {
    friend class PrefixParserTokenManager;
    friend class PrefixParser;
    protected:
      int error_count;
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, const JJString& expectedToken, Token *actual, PrefixParser *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, const JJSimpleString& production, PrefixParser *parser) {
        error_count++;
      ...
      virtual void handleOtherError(const JJString& message, PrefixParser *parser) {
  ...
  class PrefixParserTokenManager;
  class TokenManagerErrorHandler {
    ...
    public:
       ...
       //
       virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, const JJString& errorAfter, JJChar curChar, PrefixParserTokenManager* token_manager) {
       ...
       virtual void lexicalError(const JJString& errorMessage, PrefixParserTokenManager* token_manager) {
...
/* JavaCC - OriginalChecksum=49e09380250da55492d0e88664638da5 (do not edit this line) */
